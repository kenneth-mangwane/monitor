...
namespace OBS.API.Migrations.SouthPointDb
{
    ...
    [Migration("20220216214533_idVerification1")]
    partial class idVerification1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OBS.Common.BusinessObjects.BitVetureVerication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("hanisReference")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("idIssueDate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("idNumberBlocked")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("idSequenceNumber")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("onHANIS")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("onNPR")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("smartCardIssued")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SouthPointMaintenance.Data.IDVerification", b =>
                {
                    b.HasOne("OBS.Common.BusinessObjects.BitVetureVerication", "IDRecord")
                        .WithMany()
                        .HasForeignKey("IDRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
